...
- finalize name direction
- finalize product thesis
- finalize one winning demo loop
...
- agent identity and payee model
- policy model
- receipt model
- session key model
...
- scaffold frontend
- define backend API
- define minimal contract / onchain plan
...
- deny out-of-policy request
- receipt feed
- receipt detail page
- per-agent session / scope model
- pause / revoke
...
- trust markers
- privacy mode
- x402-paid service flow
- agent-to-agent spend flow
- attestation layer
- global fleet view with cross-agent filters
